...
rm -rf pub/static/* && bin/magento setup:static-content:deploy en_US <additional locales, e.g.: de_CH fr_CH it_CH rm_CH gsw_CH>
...
## Support
- [The extension's **forum** branch](https://mage2.pro/c/extensions/postfinance).
...
- [Subscribe](https://mage2.pro/t/2540) to the extension's [forum branch](https://mage2.pro/c/extensions/postfinance).
